...
public class IAService {
    ...
    private var mode: IAServiceMode
    ...
    public init(_ mode: IAServiceMode = .offline) {
        self.mode = mode
    }
    ...
    @discardableResult public func search(
        ...
        completion:@escaping SearchResponse) -> Request? {
            ...
            if mode == .offline {
                self.mockSearch(completion: completion)
                return nil
            }
    ...
    public func archiveDoc(identifier:String, completion:@escaping ArchiveDocResponse) {
        ...
        if (mode == .offline) {
            self.mockArchiveDoc(completion: completion)
            return
        }
